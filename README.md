...
**Installing Phoenix**
- For Phoenix, all dependencies and versions needed for installing can be found [here](https://hexdocs.pm/phoenix/installation.html). Postgres is recommended as the de facto database. To install versions of erlang and elixir needed for Phoenix in Action, use asdf to install previous versions.
- If asdf doesn't let you install previous version of erlang [this](https://github.com/asdf-vm/asdf-erlang/issues/221) might help.  
